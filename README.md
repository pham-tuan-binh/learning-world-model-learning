...
To scale real world data collection to such point would require an enormous effort and capital in the ranges of billions. Collecting diverse data in the real world is not simply deploying your robot everywhere like in the case of self-driving cars. It also requires building the infrastructure necessary for such task: network infrastructure, equipment infrastructure.
